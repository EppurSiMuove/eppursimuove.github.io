        ...
        >
            <div className="grid place-content-center h-auto px-4 md:w-1/2 mx-auto ">
                <div className=" text-lightText space-y-8 portrait:space-y-16">
                    ...
                    <p className="text-center text-lg md:text-2xl landscape-xs:text-2xl portrait:text-2xl md:animate-pulse hover:animate-none">
                        Hi...I&apos;m
                    ...
                    <p className="text-center text-lg md:text-xl landscape-xs:text-xl">
                        ...
                        in web technologies, and continuously learning to
                        provide optimal solutions. Collaboration and
                        ...
                        <h2 className="block mt-4 text-lg md:text-2xl landscape-xs:text-2xl portrait:text-2xl ">
